...
*Rev.A1 机械概念预览。图中的梁 STL 仅用于观察形状；实际受力件须按 316L 图纸加工。图像不代表 Rev.A2 装配干涉或防水测试通过。*
...
项目停在**有可审查的数字工程成果、没有经过实物证明的产品**这一阶段。若要继续，先修复并验证航次头 WIP，同时用所购器件图纸和板厂能力关闭装配门槛；再考虑首件制造和分级水槽试验。完整顺序见 [PCB 放行清单](hardware/revA2/PCB_RELEASE_CHECKLIST_revA2_CN.md)与[现场试验计划](validation/FIELD_TEST_PLAN_CN.md)。
